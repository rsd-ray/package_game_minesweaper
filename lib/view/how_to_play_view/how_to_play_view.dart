              ...
              child: Expanded(
                child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final List<String> howToPlays = [
                        "Tap a square to reveal it.",
                        "A number indicates how many mines are adjacent to that square.",
                        "Long press a square to flag it.",
                        "If you reveal a mine, you lose the game.",
                        "Reveal all the squares that do not contain mines to win the game."
                      ];

                  ...
                  Positioned(
                      ...
                      child: ClipRRect(
                          ...
                          child: Image.asset(win
                              ...
                              : Images.loseScreen.toPath, package: 'game_minesweaper',))),
                  Padding(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Image.asset(Images.stopwatch.toPath, package: 'game_minesweaper',),
                            ),
                        ...
                        Column(
                          children: [
                            SizedBox(
                              height: GameSizes.getWidth(0.18),
                              child: Image.asset(Images.trophy.toPath, package: 'game_minesweaper',),
                            ),
                            SizedBox(height: GameSizes.getWidth(0.01)),
                            Text(
                              record,
  ...
  static void exitGame(BuildContext context, GameController gameController) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          "Are you sure you want to exit the game? You will lose your current progress.",
          style: TextStyle(
